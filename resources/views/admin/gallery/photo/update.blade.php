      ...
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{ route('update.photo', $photo->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputUsername1" name="title" value="{{ $photo->title }}">
            @error('title')
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="file" name="photo" id="exampleInputUsername1" class="form-control">
              </div>
              <div class="col-md-6">
                <div for="">Image</div>
                <img src="{{ asset($photo->photo) }}" alt="" style="width: 150px; height:150px" />
              </div>
            </div>
          </div>
          @error('photo')
