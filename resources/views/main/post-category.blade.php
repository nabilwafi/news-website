        ...
        <div class="row">
            <div class="col-md-12">
                <div class="single_info">
                    <span>
                        @php
                          $category_name = DB::table('categories')->where('id', $first_post->category_id)->first();
                        @endphp
                        <a href="#">
                    ...
                    <div class="col-md-8 col-sm-7">
                        <div class="archive_post_sec">
                            <div class="archive_img">
                                <a href="#"><img src="{{ asset($first_post->image) }}" alt="Notebook"></a>
                            </div>
                            <div class="archive_post_height">
                                <div class="archive_heading_01">
                                    <a href="#">
                                      @if (session()->get('lang') == 'indo')
                                        {{ $first_post->title_ind }}
                                      @else
                                        {{ $first_post->title_en}}
                                      @endif
                                    </a>
                                ...
                                <div class="archive_dtails">
                                  @if (session()->get('lang') == 'indo')
                                        {{ Str::limit($first_post->details_ind, $limit = 300) }}
                                      @else
                                      {!! Str::limit($first_post->details_en, $limit = 300) !!}
                                      @endif 
                                  <span style="text-align:right"><a href="{{route('single.post', $first_post->id)}}">Read More...</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
