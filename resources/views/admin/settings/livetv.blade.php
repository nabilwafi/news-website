...
<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Update Live TV</h4>
        <form class="forms-sample" method="POST" action="{{ route('update.live.tv',$liveTv->id) }}">
          @csrf

          <div class="form-group">
            @if ($liveTv->status == 1)
              <a href="{{ route('deactive.live.tv', $liveTv->id) }}">
                <button type="button" class="btn btn-primary btn-fw">
                  Active
                </button>
              </a>
            @else
            <a href="{{ route('active.live.tv', $liveTv->id) }}">
          ...
          <div class="form-group">
            ...
            <textarea name="embed_code" id="summernote" cols="30" rows="10">{{ $liveTv->embed_code }}</textarea>
          </div>
