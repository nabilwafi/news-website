            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('add.web') }}" class="btn btn-outline-primary btn-icon-text my-2"
                            style="float: right">
                            <i class="mdi mdi-upload btn-icon-prepend"></i> Add Website
                        </a>
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($webs as $web)
                                    <tr>
                                        <td>{{ $webs->firstItem()+$loop->index }}</td>
                                        <td>{{ $web->website_name }}</td>
                                        <td>{{ $web->website_link }}</td>
                                        <td>
                                            <a href="{{ route('edit.web', $web->id) }}"
                                                class="btn-info btn">Edit</a>
                                            <a href="{{ route('delete.web', $web->id) }}"
                        ...
                        <div class="my-3">
                          {{ $webs->links('vendor.pagination.custom') }}
                        </div>
                      </div>
                </div>
            </div>
